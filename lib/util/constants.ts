...
let emojis = {
  ...
  badlyDrawnBadges: {
    DISCORD_EMPLOYEE: "<a:staff:842855345511858186>",
    PARTNERED_SERVER_OWNER: "<a:partner:842855076347641859>",
    ...
    OWNER: "<:crown:801662437509693490>",
    PARTNERED: "<a:partner_blue:842855257034063903>",
  ...
  breadBadges: {
    ...
    OWNER: "<:ownercrown:831858918161776661>", // TODO: get bread version
  ...
  breadlyDrawnBadges: {
    ...
    OWNER: "<:crown:814718422926622750>",
...
export const constants = {
  ...
  regexes: {
    ...
    invites: [
      ...
      /(?<domain>(?:discord(?:app)?|watchanimeattheoffice)\.com)\/invite\/(?<code>[\w-]+)/gim,
