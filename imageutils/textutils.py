    ...
    if emoji_set == 'apple':
        ...
        for i in range(0, len(text)):
            ...
            if emoji == 'u200D':
                ...
                emoji_img = Image.open(get_path(f'assets/emoji/{emoji}.png')).convert(
                    'RGBA').resize((emoji_size, emoji_size), Image.LANCZOS)
                if rgb:
